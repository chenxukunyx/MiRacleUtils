...
public class ActivityUtils {
     ...
     * @param options 跳转动画
     */
    public static void startActivity(Class<?> clz, Bundle options) {
        Context context = getActivityOrApp();
     ...
     * @param exitAnim  出场动画
     */
    public static void startActivity(Class<?> clz, int enterAnim, int exitAnim) {
        Context context = getActivityOrApp();
     ...
     * @param options  跳转动画
     */
    public static void startActivity(Activity activity, Class<?> clz, Bundle options) {
     ...
     */
    public static boolean finishToActivity(final Activity activity, final boolean isIncludeSelf) {
