...
public class PersistentCookieStore {
    ...
    public PersistentCookieStore(Context context) {
        ...
        for (Map.Entry<String, ?> entry : prefsMap.entrySet()) {
            ...
            for (String name : cookieNames) {
                String encoderCookie = cookiePrefs.getString(name, null);
                if (encoderCookie != null) {
                    Cookie decodeCookie = decodeCookie(encoderCookie);
    ...
    protected String encodeCookie(SerializableOkHttpCookies cookie) {
        ...
        try {
            ...
            MLog.d(TAG, "IOException in encodeCookie" + e);
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            MLog.d(TAG, "IOException in decodeCookie" + e);
        } catch (ClassNotFoundException e) {
            MLog.d(TAG, "ClassNotFoundException in decodeCookie" + e);
        }
