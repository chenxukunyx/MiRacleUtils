        ...
        if (context != null) {
            ...
            if (networkInfo != null) {
                if (networkInfo.getType() == ConnectivityManager.TYPE_MOBILE) {
                    MLog.i(TAG, "网络连接状态是：TYPE_MOBILE");
                    NetworkInfo.State state_mobile = networkInfo.getState();
